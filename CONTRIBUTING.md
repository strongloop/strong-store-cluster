...
Thank you for your interest in `strong-store-cluster`, an open source project
administered by StrongLoop.

Contributing to `strong-store-cluster` is easy. In a few simple steps:
  ...
  * Sign the [Contributor License Agreement](https://cla.strongloop.com/agreements/strongloop/strong-store-cluster)
